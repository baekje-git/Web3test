...
public class PaymentServiceImpl implements PaymentService {
	...
	@Override
	public int insertResultPayment(HashMap<String, Object> paramMap) throws Exception {
	    System.out.println(">>> insertResultPayment START");
	    System.out.println("paramMap keys = " + paramMap.keySet());
	    System.out.println("buyerEmail = " + paramMap.get("buyerEmail"));
	    System.out.println("cardNumber = " + paramMap.get("cardNumber"));

	    return (int)cmmnService.select("payment.selectSeqNoInsertResultPayment", paramMap);
	    // return paymentDao.insertResultPayment(paramMap);
	}
	@Override
	@Transactional
