<template>
  <div class="">
    <q-table
      class="orderTable_2a cart_wrap" :style="{ height: setHeight+'px' }"
      :rows="filteredRows"
...
const setHeight = ref(710);
// const setBtnName = ref("제품정보");
//라디오 클릭시 해당 품목 셀렉트
...
async function componentsExchange(){
  // buttonContainer
  // setHeight.value = "655";
  if( setHeight.value === "385") {
    // setBtnName.value = "축소";
    setHeight.value = "655";
    // await bus.emit("setDisplay");
  } else {
    // setBtnName.value = "확대";
    setHeight.value = "385";
    // await bus.emit("setDisplay");
  }
  // buttonContainer.value.style.height = '550px';
  // await bus.emit("setDisplay");
