        ...
        <q-tr class="table_container">
          <div class="table_wrap">
              ...
              <q-td class="table-td_mobile">
                ...
                <DialogComp_signature_view :data="props.row">
                  <BtnComp_active_small
                    v-if="props.row.DATA[0].SIGN_YN === 'Y'"
            ...
            <div class="table_item table_item_mobile">
              ...
              <q-td
                class="table_item_minus table-td_mobile"
                @click="props.row.expand = !props.row.expand"
                v-else
              >
                {{ util.getNumberFormat(props.row.TOTAL_AMT) }}
...
.table_wrap {
  ...
  grid-template-columns: 25% 7% 3% 10% 15% 15%;
  padding: 2% !important;
