        ...
        <div class="table_Top_wrap">
          ...
          <div class="table_totalVal">
            <span class="table_total_Text">
              검색건수 {{ util.getNumberFormat(pmntCnt ?? 0) }}건 | 수불금액 {{ util.getNumberFormat(pmntAmt ?? 0) }}원
            </span>
          </div>
        </div>
      </template>
...
import SalesDetailComp_b_mobile from 'src/components/DialogComp/3.salesDialogComp/SalesDetailComp_e_mobile.vue';
