...
<body>
	<form name="SendPayForm_id" id="SendPayForm_id" method="post">
		...
		<input type="hidden" name="returnUrl" value="http://localhost:9050/inicis/resPayment">
		<input type="hidden" name="closeUrl" value="http://localhost:9050/inicis/closePayment">
